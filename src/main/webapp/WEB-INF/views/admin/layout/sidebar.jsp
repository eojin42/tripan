...
<aside class="sidebar">
  ...
  <div class="sidebar-menu">
    ...
    <div class="menu-item has-sub ${param.activePage == 'cs' || param.activePage == 'members' ? 'active open' : ''}" onclick="toggleSubMenu(this)">
    ...
    <div class="sub-menu ${param.activePage == 'cs' || param.activePage == 'members' ? 'open' : ''}">
    ...
    <a href="${pageContext.request.contextPath}/admin/logs" class="menu-item ${param.activePage == 'log' ? 'active' : ''}">
      ...
      <span class="menu-text">시스템 및 로그 관리</span>
    </a>
  </div>
</aside>
