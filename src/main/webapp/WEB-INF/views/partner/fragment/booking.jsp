...
<div id="tab-booking" class="page-section ${activeTab == 'booking' ? 'active' : ''}">
    ...
    <div class="search-filter-box" style="background: #F8FAFC; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
        <form action="main" method="GET" id="bookingSearchForm" style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
		...
		<select name="limit" style="padding: 8px; border: 1px solid #E2E8F0; border-radius: 6px;" onchange="document.getElementById('page').value=1; this.form.submit();">
    ...
    </div> <div id="bookingPagination"></div>

</div> <div id="bookingDetailModal" class="modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const currentPage = ${empty param.page ? 1 : param.page};

    renderPagination(totalPages, currentPage, 'bookingPagination', function(selectedPage) {
